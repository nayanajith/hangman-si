...
parser.add_option("-f", "--from", dest="fr", help="Sender email address", metavar="EMAIL", action="store", type="string")
...
class Hangman(wx.Frame):
   ...
   def __init__(self, *args, **kwds):
      ...
      menu = wx.Menu()
      m_exit = menu.Append(wx.ID_EXIT, self.LANG_DICT["EXIT"], "Close window and exit program.")
      ...
      menu = wx.Menu()
      m_about = menu.Append(wx.ID_ABOUT, self.LANG_DICT["ABOUT"], "Information about this program")
   ...
   def init_keyboard(self):
      ...
      if self.LANGUAGE == "TAMIL":
         self.VOWELS = (u"அ", u"ஆ", u"இ", u"ஈ", u"உ", u"ஊ", u"எ", u"ஏ", u"ஐ", u"ஒ", u"ஓ", u"ஔ")
         self.CONSONENTS = (u"க", u"ங", u"ச", u"ஞ", u"ட", u"ண", u"த", u"ந", u"ப", u"ம", u"ய", u"ர", u"ல", u"வ", u"ழ", u"ள", u"ற", u"ன", u"ஶ", u"ஜ", u"ஷ", u"ஸ", u"ஹ", u"க", u"ஷ")
         self.VOWEL_DIACRITICS = (u"்", u"ா", u"ி", u"ீ", u"ு", u"ூ", u"ெ", u"ே", u"ை", u"ொ", u"ோ", u"ௌ")
         ...
         self.CONSONENTS = (u"ක", u"ඛ", u"ග", u"ඝ", u"ඞ", u"ඟ", u"ච", u"ඡ", u"ජ", u"ඣ", u"ඤ", u"ඥ", u"ට", u"ඨ", u"ඩ", u"ඪ", u"ණ", u"ඬ", u"ත", u"ථ", u"ද", u"ධ", u"න", u"ඳ", u"ප", u"ඵ", u"බ", u"භ", u"ම", u"ඹ", u"ය", u"ර", u"ල", u"ව", u"ශ", u"ෂ", u"ස", u"හ", u"ළ", u"ෆ")
         self.VOWEL_DIACRITICS = (u"්", u"ා", u"ැ", u"ෑ", u"ි", u"ී", u"ු", u"ූ", u"ෙ", u"ේ", u"ො", u"ෝ", u"ෞ", u"ෟ", u"ෘ", u"ෛ", u"ං", u"ඃ")
      ...
      '''
      if self.LEVEL == 1 :
         self.cheat_button = wx.Button(self, 999, label=self.LANG_DICT["HELP"], pos=((self.FONT_SIZE * 28) + 65, 20), size=(self.FONT_SIZE + 47, self.FONT_SIZE + 35))
         wx.EVT_BUTTON(self, 999, self.cheat_game)
      
      '''
      Game restart button
      '''
      self.restart_button = wx.Button(self, 1001, label=self.LANG_DICT["NEW_WORD"], pos=((self.FONT_SIZE * 10) + 300, 500))
      wx.EVT_BUTTON(self, 1001, self.restart_game)
      
      '''
      Game close button
      '''
      self.restart_button = wx.Button(self, 1002, label=self.LANG_DICT["EXIT"], pos=((self.FONT_SIZE * 10) + 100, 500))
   ...
   def config_panel(self, event):
      ...
      grid1.Add(wx.StaticText(panel1, -1, self.LANG_DICT["CATEGORY"] + " :", (5, 5)), 0, wx.ALIGN_CENTER_VERTICAL)
   ...
   def onClose(self, event):
      dlg = wx.MessageDialog(self, self.NAME + self.LANG_DICT["OK_TO_CLOSE"] + "?", self.LANG_DICT["OK_TO_CLOSE"], wx.OK | wx.CANCEL | wx.ICON_EXCLAMATION)
   ...
   def onAbout(self, event):
      dlg = wx.MessageDialog(self, self.NAME + u"\n\n\n " + self.LANG_DICT["GAME"] + "\n ", self.LANG_DICT["INTRODUCTION"], wx.OK | wx.ICON_INFORMATION)
   ...
   def check_letter(self, letter, reset, cheat):
      ...
      if word == self.CHALLENGE_WORD:
         ...
         dlg = wx.MessageDialog(self, self.LANG_DICT["HELP"] + ":" + str(self.cheat_count) + u"\n\n" + self.LANG_DICT["YOU_WON"] + "!", self.LANG_DICT["RESULTS"], wx.OK | wx.ICON_INFORMATION)
         dlg.SetFont(self.DEFAULT_FONT)
         dlg.ShowModal()
         dlg.Destroy()
      ...
      if self.NO_OF_CHANSES == self.chances:
         ...
         #self.textArea.SetValue(word)
         dlg = wx.MessageDialog(self, self.LANG_DICT["YOU_LOST"] + "!", self.LANG_DICT["RESULTS"], wx.OK | wx.ICON_INFORMATION)
         dlg.SetFont(self.DEFAULT_FONT)
         dlg.ShowModal()
         dlg.Destroy()
